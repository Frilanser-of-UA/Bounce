...
let moreTextButton = document.querySelector('.this__btn');
if (moreTextButton) {
	moreTextButton.addEventListener("click", function (e) {
		moreTextButton.classList.toggle("_active")
		moreText.classList.toggle("_active")
		e.preventDefault();
		return false;
	}, false);
};
...
var bar = new ProgressBar.Circle('#container-2', {
	color: '#19bd9a',
	easing: 'easeOut',
	strokeWidth: '3',
	trailColor: '#047378',
...
var bar = new ProgressBar.Circle('#container-3', {
	color: '#19bd9a',
	easing: 'easeOut',
	strokeWidth: '3',
	trailColor: '#047378',
...
var bar = new ProgressBar.Line("#container-4", {
	color: '#19bd9a',
	easing: 'easeOut',
	strokeWidth: '1',
	trailColor: '#e1e4e9',
...
var bar = new ProgressBar.Line("#container-5", {
	color: '#19bd9a',
	easing: 'easeOut',
	strokeWidth: '1',
	trailColor: '#e1e4e9',
...
var bar = new ProgressBar.Line("#container-6", {
	color: '#19bd9a',
	easing: 'easeOut',
	strokeWidth: '1',
	trailColor: '#e1e4e9',
...
// easyIn, easeOut, easeInOut или bounce.
var bar = new ProgressBar.Line("#container-7", {
	color: '#19bd9a',
	easing: 'easeOut',
	strokeWidth: '1',
	trailColor: '#e1e4e9',
...
var bar = new ProgressBar.Line("#container-8", {
	color: '#19bd9a',
	easing: 'easeOut',
	strokeWidth: '1',
	trailColor: '#e1e4e9',
...
var bar = new ProgressBar.Line("#container-9", {
	color: '#19bd9a',
	easing: 'easeOut',
	strokeWidth: '1',
	trailColor: '#e1e4e9',
...
var bar = new ProgressBar.Line("#container-10", {
	color: '#19bd9a',
	easing: 'easeOut',
	strokeWidth: '1',
	trailColor: '#e1e4e9',
...
var bar = new ProgressBar.Line("#container-11", {
	color: '#19bd9a',
	easing: 'easeOut',
	strokeWidth: '1',
	trailColor: '#e1e4e9',
...
var bar = new ProgressBar.Line("#container-12", {
	color: '#19bd9a',
	easing: 'easeOut',
	strokeWidth: '1',
	trailColor: '#e1e4e9',
...
if (angleMap) {
	let angleDown = document.querySelector('.map__angle');
...
function mapAdd() {
	...
	tag.src = "https://maps.google.com/maps/api/js?key=AIzaSyB8Y--XwkKbkbcdpkjcY2YRdu46L_aJa0s&callback=mapInit";
...
function mapInit(n = 1) {
	...
	var locations = [
		[new google.maps.LatLng(51.52266405462122, 0.03145710405326272)],
		[new google.maps.LatLng(51.52266405462122, 0.03145710405326272)],
		[new google.maps.LatLng(51.52266405462122, 0.03145710405326272)],
		[new google.maps.LatLng(51.52266405462122, 0.03145710405326272)],
	]
